...
invisivel db CR,LF,'Foi digitado um caractere "invisivel"','$'
...
escape11H db CR,LF,'Foi digitado o caractere: ESC (codigo ASCII em hexa: 11H)',CR,LF,'$'
fechaASC  db 'H)',CR,LF,'$'
fechaScan db 'H',CR,LF,'$'
msg_final db CR,LF,'Fim do programa. Espero que tenha aprendido todos os codigos ... ',02H,' !',CR,LF,'$'
dados     ends
